...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/coding/ethz_asl_UAV_autonomous/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/coding/ethz_asl_UAV_autonomous/install/lib;/home/ubuntu/coding/ros-mapping-ws/devel/lib;/home/ubuntu/coding/ros-SLAM-ws/devel/lib;/home/ubuntu/coding/MYNT-SDK/MYNT-EYE-D-SDK/wrappers/ros/devel/lib;/home/ubuntu/coding/px4-simulation/avoidance_ros_ws/devel/lib;/home/ubuntu/coding/px4-simulation/gazebo_ros_ws/devel/lib;/opt/ros/kinetic/lib)
