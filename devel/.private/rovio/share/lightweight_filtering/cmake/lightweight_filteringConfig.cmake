...
if(NOT "/home/ubuntu/coding/ethz_asl_UAV_autonomous/src/rovio/lightweight_filtering/include;/home/ubuntu/coding/ethz_asl_UAV_autonomous/devel/include;/usr/include/eigen3 " STREQUAL " ")
  set(lightweight_filtering_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/coding/ethz_asl_UAV_autonomous/src/rovio/lightweight_filtering/include;/home/ubuntu/coding/ethz_asl_UAV_autonomous/devel/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lightweight_filtering' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/coding/ethz_asl_UAV_autonomous/src/rovio/lightweight_filtering/${idir}'.  ${_report}")
    endif()
